...
import { PhysicsCreationHowItWorks } from "@/components/programs/physics-creation/PhysicsCreationHowItWorks";
...
const NEED_TO_KNOW = [
  {
    ...
    body: (
      <p className="text-base leading-relaxed text-charcoal md:text-lg">
        <span className="font-semibold text-navy">Kansas City area</span>{" "}
        in-person, or an{" "}
        <span className="font-semibold text-navy">online</span> presentation
      </p>
    ),
  },
  {
    ...
    body: (
      <p className="text-base leading-relaxed text-charcoal md:text-lg">
        <span className="font-semibold text-navy">30 minutes</span> to{" "}
        <span className="font-semibold text-navy">3 hours</span>
        <span className="text-charcoal/80"> — customized to your group</span>
      </p>
    ),
  },
  {
    ...
    body: (
      <p className="text-base leading-relaxed text-charcoal md:text-lg">
        <span className="font-semibold text-navy">Customized</span> based on
        location, time, and group size
      </p>
    ),
  },
  {
    ...
    body: (
      <ul className="list-inside list-disc space-y-1.5 text-base leading-relaxed text-charcoal marker:text-sky md:text-lg">
        <li>Homeschool groups &amp; co-ops</li>
        <li>Church youth groups</li>
        <li>Public school assemblies</li>
      </ul>
    ),
  },
] as const;

export function PhysicsCreationProgramDetails() {
  return (
